                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-info"><a class="dropdown-item" href="?pagina=usuario&idusuario=<?= $user->getIdusuario(); ?>">Editar</a></button>
                                        <button class="btn btn-warning"><a class="dropdown-item" href="?pagina=alterarsenha&idusuario=<?= $user->getIdusuario(); ?>">Alterar senha</a></button>
                                    </td>
                                </tr>
                                <?php
                            }
                            ...
                            if ($listarTodos != null) {
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= $user->getPermissao() == 1 ? "<span style='color: green;'>Administrador</span>" : "<span class='glyphicon glyphicon-user' style='color: red;'></span> <span style='color: red;'>Comum</span>" ?></td>
                                        <td>
                                            <button class="btn btn-info"><a href="?pagina=usuario&idusuario=<?= $user->getIdusuario(); ?>">Editar</a></button>
                                            <button class="btn btn-warning"><a href="?pagina=alterarsenha&idusuario=<?= $user->getIdusuario(); ?>">Alterar senha</a></button>
                                        </td>
                                    </tr>
                        <?php
                                }
