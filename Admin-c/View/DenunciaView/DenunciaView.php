                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-info"><a href="?pagina=denuncia&iddenuncia=<?= $denuncia->getIddenuncia(); ?>">Editar</a></button>
                                            <button class="btn btn-warning"><a href="?pagina=gerenciarimagemdenuncia&iddenuncia=<?= $denuncia->getIddenuncia(); ?>">Gerenciar Imagens</a></button>
                                            <button class="btn btn-info"><a href="?pagina=visualizardenuncia&iddenuncia=<?= $denuncia->getIddenuncia(); ?>">Visualizar Denuncia</a></button>
                                        </td>
                                    </tr>
                                <?php
                                }
