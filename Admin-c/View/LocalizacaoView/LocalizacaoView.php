                        ...
                        <div class="row">
                            <div class="col-lg-6 col-xs-12">
                                ...
                                <div class="spaceAround">
                                    <a href="?pagina=localizacao&idlocalizacao=<?= $localizacao->getIdlocalizacao(); ?>" class="btn btn-info">Editar</a>
                                    <a href="?pagina=localizacaoimagem&idlocalizacao=<?= $localizacao->getIdlocalizacao(); ?>&img=<?= $localizacao->getThumb(); ?>" class="btn btn-warning">Alterar imagem</a>
                                </div>
                                <br>
                            </div>
                            <div class="col-lg-6 col-xs-12">
