...
if ($del) {
    if ($comentarioController->Remover($del)) {
        $resultado = "<div class=\"alert alert-success\" role=\"alert\">Comentário removido com sucesso</div>";
    } else {
        $resultado = "<div class=\"alert alert-danger\" role=\"alert\">Houve um erro ao tentar remover o comentário</div>";
    }
}
...
if (filter_input(INPUT_POST, "btnResponder", FILTER_SANITIZE_STRING)) {
    ...
    if ($comentarioController->Cadastrar($comentario)) {
        $resultado = "<div class=\"alert alert-success\" role=\"alert\">Comentário cadastrado com sucesso</div>";
    } else {
        $resultado = "<div class=\"alert alert-danger\" role=\"alert\">Houve um erro ao tentar cadastrar o comentário</div>";
    }
}
?>
